...
<?php } ?>
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $path_update . $user['id']; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
            <tr>
              <td><?php echo $text_username; ?></td>
              <td><strong><?php echo $user['username']; ?></strong></td>
              <td><?php echo $text_company; ?></td>
              <td><strong><?php echo $companies; ?></strong></td>
            </tr>
            <tr>		
            ...
            <tr>
              ...
              <td><strong><?php echo $user['cellphone']; ?></strong></td>
              <td></td>
              <td></td>
            </tr>
          </table>
