      ...
      <form action="<?php echo $path_update; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="username" tabindex="1" value="<?php echo $user['username']; ?>" size="30" />
            ...
            <tr>
              ...
              <td><input type="checkbox" name="isCompAdmin" tabindex="10" <?php echo $user['isCompAdmin']; ?>/></td>
            </tr>
            <tr>
