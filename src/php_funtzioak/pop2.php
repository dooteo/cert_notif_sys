...
/**
* TrustedTimestamps.php - Creates Timestamp Requestfiles, processes the request at a 
* Timestamp Authority (TSA) after RFC 3161
...
class TrustedTimestamps {
	...
	*/
	public static function createRequestfile ($type, $hash) {
		switch ($type) {
		case 'sha1':
			$hash_lenght = 40;
			$query_option = '';
	...
	* @return <type>
	*/
	public static function validate ($hash, $base64_response_string, 
