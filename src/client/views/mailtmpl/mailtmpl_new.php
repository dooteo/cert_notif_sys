    ...
    <div class="content">
      <form action="<?php echo $path_insert; ?>" method="post" enctype="multipart/form-data" id="form">
          <table id="dataTable" class="form">
            ...
            <tr class="notopborder">
              <td><?php echo $text_multilang; ?></td>
              <td><input type="checkbox" name="multilang" tabindex="6" /></td>
            ...
            <tr class="notopborder">
              <td><?php echo $text_isHTML; ?></td>
              <td><input type="checkbox" name="isHTML" tabindex="7"/></td>
