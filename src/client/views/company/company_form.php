    ...
    <form action="<?php echo $path_update ?>" method="post" id="form">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="phone1" tabindex="9" value="<?php echo $company['phone1']; ?>" size="30" /></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="phone2" tabindex="10" value="<?php echo $company['phone2']; ?>" size="30" /></td>
            </tr>
            <tr>
              <td><?php echo $text_city; ?></td>
              <td><input type="text" name="city" tabindex="5" value="<?php echo $company['city']; ?>" size="30" /></td>
              <td><?php echo $text_email1; ?></td>
              <td><input type="text" name="email1" tabindex="11" value="<?php echo $company['email1']; ?>" size="30" /></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="email2" tabindex="12" value="<?php echo $company['email2']; ?>" size="30" /></td>
            </tr>
            <tr>
              <td><?php echo $text_country; ?></td>
              <td><input type="text" name="country" tabindex="7" value="<?php echo $company['country']; ?>" size="30" /></td>
              <td><?php echo $text_website; ?></td>
              <td><input type="text" name="website" tabindex="13" value="<?php echo $company['website']; ?>" size="30" /></td>
            </tr>
          </table>
      </form>
  </div>
