...
$route['default_controller'] = "common/check/index";
$route['common/check/(:any)'] = "common/check/index/$1";
$route['check/common/(:any)'] = "common/check/index/$1";
$route['check/(:any)'] = "common/check/index/$1";
$route['common/(:any)'] = "common/check/index/$1";
$route['(:any)'] = "common/check/index/$1";
$route['404_override'] = '';
